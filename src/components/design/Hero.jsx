...
export const Gradient = () => {
  return (
    <>
      ...
      <div className="relative z-1 h-6 mx-6 bg-n-11 shadow-xl rounded-b-[1.25rem] lg:h-6 lg:mx-20" />
    </>
  );
};
...
export const BackgroundCircles = ({ parallaxRef }) => {
  ...
  return (
    <div className="absolute -top-[42.375rem] left-1/2 w-[78rem] aspect-square  -translate-x-1/2 md:-top-[38.5rem] xl:-top-[32rem] z-0">
      <Rings />
